...
#python export.py --weights runs/train/exp4/weights/best.pt --include onnx engine ！！！！！！！！！！！！！！！！！！！

def parse_opt(known=False):
    parser = argparse.ArgumentParser()
    parser.add_argument('--data', type=str, default='E:/bishe/yolov5/yolov5-master/data/laji.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default= 'E:/bishe/yolov5/yolov5-master/runs/train/exp4/weights/best.pt', help='model.pt path(s)')
